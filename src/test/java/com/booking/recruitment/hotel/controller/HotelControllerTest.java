...
class HotelControllerTest {
  ...
  private String GET_HOTEL_ID = "10";
  private String DELETED_HOTEL_ID = "2";
  ...
  @Test
  @DisplayName("Should return a hotel with same id as queried")
  void hotelWithIdRequested() throws Exception {
    mockMvc
            .perform(get(String.format("/hotel/%s", GET_HOTEL_ID)))
            .andExpect(status().isOk())
            .andExpect(jsonPath("$.id", equalTo(10)));
  }

  @Test
  @DisplayName("Should return a error in case the hotel is deleted")
  void deletedHotelWithIdRequested() throws Exception {
    mockMvc
            .perform(get(String.format("/hotel/%s", DELETED_HOTEL_ID)))
